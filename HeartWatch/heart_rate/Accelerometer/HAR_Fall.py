...
def call_model (data):
    ...
    CNN_model = load_model('/home/heartwatch/rajnishh/Heart_watch/HeartWatch/heart_rate/Accelerometer/CNN_Features_Corr_10s.h5') # Server File Path
    # CNN_model = load_model('/home/rajnish/Music/Heart_watch/HeartWatch/heart_rate/Accelerometer/CNN_Features_Corr_10s.h5') # Local File Path
    window_size = 10
    two_minutes = 120
    predict_activity = []
    fall_timestamps = []
